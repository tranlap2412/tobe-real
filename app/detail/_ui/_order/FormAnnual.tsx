...
interface FormAnnualProps {
    onClick: (state:boolean) => void;
}
const FormAnnual:React.FC<FormAnnualProps> = ({onClick}) => {
    ...
    return (
        <div className='h-full flex flex-col justify-between w-full'>
            ...
            <div className='flex flex-col items-stretch mt-5 xl:mt-0'>
                {/* total */}
                <div className='font-medium font-montserrat leading-5 flex flex-wrap justify-start lg:justify-between gap-3 mb-6 px-4'>
                    <span>Total:</span>
                    <span>$ 349,888.300</span>
                </div>
                <p
